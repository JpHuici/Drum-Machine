...
const playRecording = () => {
    ...
    return (
    <div id="drum-machine" className="bg-dark min-vh-100 text-white">
            <div id="display" className="text-center">
                <h2>Drum Machine</h2>
                <div className="drum-pad" id='clip.keyTrigger'>
                    {audioClips.map((clip) => (
                ...
                {recording && (
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <button onClick={playRecording} className="btn btn-light">Play</button>
                      </div>
                      <div className="col-md-6">
